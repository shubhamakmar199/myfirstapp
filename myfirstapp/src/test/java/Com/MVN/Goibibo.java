...
public class Goibibo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
//		driver.findElement(By.xpath("//span[@data-testid=\"calendarLeftArrowBtn\"]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[@data-testid=\"date_li_12_5_2023\"]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[@data-testid=\"date_li_16_5_2023\"]")).click();
		Thread.sleep(1000);
